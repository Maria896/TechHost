...
<!-- banner section -->
<section class="xs-banner service-banner contet-to-center" style="min-height: 500px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-7 align-self-center">
                <div class="xs-banner-content">
                    <div class="xs-banner-group">
                        <h2 class="banner-title wow fadeInLeft" data-wow-duration="1s">BUSINESS HOSTING</h2>
            ...
            <div class="col-lg-5 align-self-center" style="margin-top: 50px;">
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="xs-heading wow fadeIn">
                    ...
                    <h3 class="heading-title"><span>BUSINESS HOSTING IN LAHORE</span></h3>
